...
const VansTrucks: React.FC = () => {
  return (
    <div className='min-h-screen pt-[10%]' id="mobile">
        ...
        <div className='p-[5%]'>
          <iframe 
          src="https://home.mobile.de/home/index.html?partnerHead=false&amp;colorTheme=default&amp;customerId=11719026#ses" 
          name='Fahrzeugangebot' id="Fahrzeugangebot"
          className='w-full h-screen border-2 rounded-lg'/>
          <a 
          target="_blank" rel='noopener noreferrer'
          href='https://home.mobile.de/home/index.html?partnerHead=false&amp;colorTheme=default&amp;customerId=11719026#ses'>

...
function Privacy() {
  return (
    ...
    <div className='h-screen'>
        ...
        <p className='mt-4'><span className='text-xl'>1. Datenschutz auf einen Blick</span><br/>
<span className='underline'>Allgemeine Hinweise</span><br/><br/>
Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie unsere Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können. Ausführliche Informationen zum Thema Datenschutz entnehmen Sie unserer unter diesem Text aufgeführten Datenschutzerklärung.
<br/><br/>
<span className='text-xl'>Datenerfassung auf unserer Website</span><br/>
...
Beim Besuch unserer Website kann Ihr Surf-Verhalten statistisch ausgewertet werden. Das geschieht mit sogenannten Analyseprogrammen. Die Analyse Ihres Surf-Verhaltens erfolgt in der Regel anonym; das Surf-Verhalten kann nicht zu Ihnen zurückverfolgt werden.

Sie können dieser Analyse widersprechen oder sie durch die Nichtbenutzung bestimmter Tools verhindern. Detaillierte Informationen zu diesen Tools und über Ihre Widerspruchsmöglichkeiten finden Sie in der folgenden Datenschutzerklärung.
<br/><br/>

<span className='text-xl'>2. Allgemeine Hinweise und Pflichtinformationen</span><br/>
<span className='underline'>Datenschutz</span><br/><br/>
...
<br/><br/>
Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)<br/><br/>
...
<br/><br/>
<span className='text-xl'>3. Datenerfassung auf unserer Website</span><br/>
...
<br/><br/>
<span className='text-xl'>4. Plugins und Tools</span><br/>
<span className='underline'>Google Web Fonts</span><br/>
...
Mehr Informationen zum Umgang mit Nutzerdaten finden Sie in der Datenschutzerklärung von Google: <a href='https://www.google.de/intl/de/policies/privacy/' target='_blank' className='underline'
